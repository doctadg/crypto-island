...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Jn,depthTest:!1,depthWrite:!1})}function rc(){return new pn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ua(),fragmentShader:`
		...
		`,blending:Jn,depthTest:!1,depthWrite:!1})}function sc(){return new pn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ua(),fragmentShader:`
	...
	`}function jf(i){let t=new WeakMap,e=null;function n(a){if(a&&a.isTexture){const c=a.mapping,l=c===vo||c===xo,h=c===Vi||c===Gi;if(l||h){let p=t.get(a);const f=p!==void 0?p.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==f)return e===null&&(e=new nc(i)),p=l?e.fromEquirectangular(a,p):e.fromCubemap(a,p),p.texture.pmremVersion=a.pmremVersion,t.set(a,p),p.texture;if(p!==void 0)return p.texture;{const d=a.image;return l&&d&&d.height>0||h&&d&&r(d)?(e===null&&(e=new nc(i)),p=l?e.fromEquirectangular(a):e.fromCubemap(a),p.texture.pmremVersion=a.pmremVersion,t.set(a,p),a.addEventListener("dispose",s),p.texture):null}}}return a}function r(a){let c=0;const l=6;for(let h=0;h<l;h++)a[h]!==void 0&&c++;return c===l}function s(a){const c=a.target;c.removeEventListener("dispose",s);const l=t.get(c);l!==void 0&&(t.delete(c),l.dispose())}function o(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:o}}function Qf(i){const t={};function e(n){if(t[n]!==void 0)return t[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return t[n]=r,r}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const r=e(n);return r===null&&cr("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function tp(i,t,e,n){const r={},s=new WeakMap;function o(p){const f=p.target;f.index!==null&&t.remove(f.index);for(const g in f.attributes)t.remove(f.attributes[g]);for(const g in f.morphAttributes){const _=f.morphAttributes[g];for(let m=0,u=_.length;m<u;m++)t.remove(_[m])}f.removeEventListener("dispose",o),delete r[f.id];const d=s.get(f);d&&(t.remove(d),s.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,e.memory.geometries--}function a(p,f){return r[f.id]===!0||(f.addEventListener("dispose",o),r[f.id]=!0,e.memory.geometries++),f}function c(p){const f=p.attributes;for(const g in f)t.update(f[g],i.ARRAY_BUFFER);const d=p.morphAttributes;for(const g in d){const _=d[g];for(let m=0,u=_.length;m<u;m++)t.update(_[m],i.ARRAY_BUFFER)}}function l(p){const f=[],d=p.index,g=p.attributes.position;let _=0;if(d!==null){const E=d.array;_=d.version;for(let T=0,S=E.length;T<S;T+=3){const N=E[T+0],w=E[T+1],A=E[T+2];f.push(N,w,w,A,A,N)}}else if(g!==void 0){const E=g.array;_=g.version;for(let T=0,S=E.length/3-1;T<S;T+=3){const N=T+0,w=T+1,A=T+2;f.push(N,w,w,A,A,N)}}else return;const m=new(ol(f)?fl:dl)(f,1);m.version=_;const u=s.get(p);u&&t.remove(u),s.set(p,m)}function h(p){const f=s.get(p);if(f){const d=p.index;d!==null&&f.version<d.version&&l(p)}else l(p);return s.get(p)}return{get:a,update:c,getWireframeAttribute:h}}function ep(i,t,e){let n;function r(f){n=f}let s,o;function a(f){s=f.type,o=f.bytesPerElement}function c(f,d){i.drawElements(n,d,s,f*o),e.update(d,n,1)}function l(f,d,g){g!==0&&(i.drawElementsInstanced(n,d,s,f*o,g),e.update(d,n,g))}function h(f,d,g){if(g===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,d,0,s,f,0,g);let m=0;for(let u=0;u<g;u++)m+=d[u];e.update(m,n,1)}function p(f,d,g,_){if(g===0)return;const m=t.get("WEBGL_multi_draw");if(m===null)for(let u=0;u<f.length;u++)l(f[u]/o,d[u],_[u]);else{m.multiDrawElementsInstancedWEBGL(n,d,0,s,f,0,_,0,g);let u=0;for(let E=0;E<g;E++)u+=d[E]*_[E];e.update(u,n,1)}}this.setMode=r,this.setIndex=a,this.render=c,this.renderInstances=l,this.renderMultiDraw=h,this.renderMultiDrawInstances=p}function np(i){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,o,a){switch(e.calls++,o){case i.TRIANGLES:e.triangles+=a*(s/3);break;case i.LINES:e.lines+=a*(s/2);break;case i.LINE_STRIP:e.lines+=a*(s-1);break;case i.LINE_LOOP:e.lines+=a*s;break;case i.POINTS:e.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:r,update:n}}function ip(i,t,e){const n=new WeakMap,r=new he;function s(o,a,c){const l=o.morphTargetInfluences,h=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,p=h!==void 0?h.length:0;let f=n.get(a);if(f===void 0||f.count!==p){let M=function(){R.dispose(),n.delete(a),a.removeEventListener("dispose",M)};var d=M;f!==void 0&&f.texture.dispose();const g=a.morphAttributes.position!==void 0,_=a.morphAttributes.normal!==void 0,m=a.morphAttributes.color!==void 0,u=a.morphAttributes.position||[],E=a.morphAttributes.normal||[],T=a.morphAttributes.color||[];let S=0;g===!0&&(S=1),_===!0&&(S=2),m===!0&&(S=3);let N=a.attributes.position.count*S,w=1;N>t.maxTextureSize&&(w=Math.ceil(N/t.maxTextureSize),N=t.maxTextureSize);const A=new Float32Array(N*w*4*p),R=new cl(A,N,w,p);R.type=wn,R.needsUpdate=!0;const y=S*4;for(let C=0;C<p;C++){const k=u[C],z=E[C],X=T[C],J=N*w*4*C;for(let W=0;W<k.count;W++){const j=W*y;g===!0&&(r.fromBufferAttribute(k,W),A[J+j+0]=r.x,A[J+j+1]=r.y,A[J+j+2]=r.z,A[J+j+3]=0),_===!0&&(r.fromBufferAttribute(z,W),A[J+j+4]=r.x,A[J+j+5]=r.y,A[J+j+6]=r.z,A[J+j+7]=0),m===!0&&(r.fromBufferAttribute(X,W),A[J+j+8]=r.x,A[J+j+9]=r.y,A[J+j+10]=r.z,A[J+j+11]=X.itemSize===4?r.w:1)}}f={count:p,texture:R,size:new pt(N,w)},n.set(a,f),a.addEventListener("dispose",M)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",o.morphTexture,e);else{let g=0;for(let m=0;m<l.length;m++)g+=l[m];const _=a.morphTargetsRelative?1:1-g;c.getUniforms().setValue(i,"morphTargetBaseInfluence",_),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",f.texture,e),c.getUniforms().setValue(i,"morphTargetsTextureSize",f.size)}return{update:s}}function rp(i,t,e,n){let r=new WeakMap;function s(c){const l=n.render.frame,h=c.geometry,p=t.get(c,h);if(r.get(p)!==l&&(t.update(p),r.set(p,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),r.get(c)!==l&&(e.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&e.update(c.instanceColor,i.ARRAY_BUFFER),r.set(c,l))),c.isSkinnedMesh){const f=c.skeleton;r.get(f)!==l&&(f.update(),r.set(f,l))}return p}function o(){r=new WeakMap}function a(c){const l=c.target;l.removeEventListener("dispose",a),e.remove(l.instanceMatrix),l.instanceColor!==null&&e.remove(l.instanceColor)}return{update:s,dispose:o}}class xl extends De{constructor(t,e,n,r,s,o,a,c,l,h=zi){if(h!==zi&&h!==Xi)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===zi&&(n=_i),n===void 0&&h===Xi&&(n=Wi),super(null,r,s,o,a,c,h,n,l),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=a!==void 0?a:on,this.minFilter=c!==void 0?c:on,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){const e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}}const Ml=new De,oc=new xl(1,1),Sl=new cl,yl=new Gu,El=new gl,ac=[],cc=[],lc=new Float32Array(16),uc=new Float32Array(9),hc=new Float32Array(4);function Zi(i,t,e){const n=i[0];if(n<=0||n>0)return i;const r=t*e;let s=ac[r];if(s===void 0&&(s=new Float32Array(r),ac[r]=s),t!==0){n.toArray(s,0);for(let o=1,a=0;o!==t;++o)a+=e,i[o].toArray(s,a)}return s}function ge(i,t){if(i.length!==t.length)return!1;for(let e=0,n=i.length;e<n;e++)if(i[e]!==t[e])return!1;return!0}function _e(i,t){for(let e=0,n=t.length;e<n;e++)i[e]=t[e]}function ms(i,t){let e=cc[t];e===void 0&&(e=new Int32Array(t),cc[t]=e);for(let n=0;n!==t;++n)e[n]=i.allocateTextureUnit();return e}function sp(i,t){const e=this.cache;e[0]!==t&&(i.uniform1f(this.addr,t),e[0]=t)}function op(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ge(e,t))return;i.uniform2fv(this.addr,t),_e(e,t)}}function ap(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(i.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(ge(e,t))return;i.uniform3fv(this.addr,t),_e(e,t)}}function cp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ge(e,t))return;i.uniform4fv(this.addr,t),_e(e,t)}}function lp(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(ge(e,t))return;i.uniformMatrix2fv(this.addr,!1,t),_e(e,t)}else{if(ge(e,n))return;hc.set(n),i.uniformMatrix2fv(this.addr,!1,hc),_e(e,n)}}function up(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(ge(e,t))return;i.uniformMatrix3fv(this.addr,!1,t),_e(e,t)}else{if(ge(e,n))return;uc.set(n),i.uniformMatrix3fv(this.addr,!1,uc),_e(e,n)}}function hp(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(ge(e,t))return;i.uniformMatrix4fv(this.addr,!1,t),_e(e,t)}else{if(ge(e,n))return;lc.set(n),i.uniformMatrix4fv(this.addr,!1,lc),_e(e,n)}}function dp(i,t){const e=this.cache;e[0]!==t&&(i.uniform1i(this.addr,t),e[0]=t)}function fp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ge(e,t))return;i.uniform2iv(this.addr,t),_e(e,t)}}function pp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(ge(e,t))return;i.uniform3iv(this.addr,t),_e(e,t)}}function mp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ge(e,t))return;i.uniform4iv(this.addr,t),_e(e,t)}}function gp(i,t){const e=this.cache;e[0]!==t&&(i.uniform1ui(this.addr,t),e[0]=t)}function _p(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ge(e,t))return;i.uniform2uiv(this.addr,t),_e(e,t)}}function vp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(ge(e,t))return;i.uniform3uiv(this.addr,t),_e(e,t)}}function xp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ge(e,t))return;i.uniform4uiv(this.addr,t),_e(e,t)}}function Mp(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);let s;this.type===i.SAMPLER_2D_SHADOW?(oc.compareFunction=sl,s=oc):s=Ml,e.setTexture2D(t||s,r)}function Sp(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTexture3D(t||yl,r)}function yp(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTextureCube(t||El,r)}function Ep(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTexture2DArray(t||Sl,r)}function Tp(i){switch(i){case 5126:return sp;case 35664:return op;case 35665:return ap;case 35666:return cp;case 35674:return lp;case 35675:return up;case 35676:return hp;case 5124:case 35670:return dp;case 35667:case 35671:return fp;case 35668:case 35672:return pp;case 35669:case 35673:return mp;case 5125:return gp;case 36294:return _p;case 36295:return vp;case 36296:return xp;case 35678:case 36198:case 36298:case 36306:case 35682:return Mp;case 35679:case 36299:case 36307:return Sp;case 35680:case 36300:case 36308:case 36293:return yp;case 36289:case 36303:case 36311:case 36292:return Ep}}function bp(i,t){i.uniform1fv(this.addr,t)}function Ap(i,t){const e=Zi(t,this.size,2);i.uniform2fv(this.addr,e)}function wp(i,t){const e=Zi(t,this.size,3);i.uniform3fv(this.addr,e)}function Rp(i,t){const e=Zi(t,this.size,4);i.uniform4fv(this.addr,e)}function Cp(i,t){const e=Zi(t,this.size,4);i.uniformMatrix2fv(this.addr,!1,e)}function Pp(i,t){const e=Zi(t,this.size,9);i.uniformMatrix3fv(this.addr,!1,e)}function Lp(i,t){const e=Zi(t,this.size,16);i.uniformMatrix4fv(this.addr,!1,e)}function Dp(i,t){i.uniform1iv(this.addr,t)}function Ip(i,t){i.uniform2iv(this.addr,t)}function Up(i,t){i.uniform3iv(this.addr,t)}function Np(i,t){i.uniform4iv(this.addr,t)}function Fp(i,t){i.uniform1uiv(this.addr,t)}function Op(i,t){i.uniform2uiv(this.addr,t)}function Bp(i,t){i.uniform3uiv(this.addr,t)}function zp(i,t){i.uniform4uiv(this.addr,t)}function kp(i,t,e){const n=this.cache,r=t.length,s=ms(e,r);ge(n,s)||(i.uniform1iv(this.addr,s),_e(n,s));for(let o=0;o!==r;++o)e.setTexture2D(t[o]||Ml,s[o])}function Hp(i,t,e){const n=this.cache,r=t.length,s=ms(e,r);ge(n,s)||(i.uniform1iv(this.addr,s),_e(n,s));for(let o=0;o!==r;++o)e.setTexture3D(t[o]||yl,s[o])}function Vp(i,t,e){const n=this.cache,r=t.length,s=ms(e,r);ge(n,s)||(i.uniform1iv(this.addr,s),_e(n,s));for(let o=0;o!==r;++o)e.setTextureCube(t[o]||El,s[o])}function Gp(i,t,e){const n=this.cache,r=t.length,s=ms(e,r);ge(n,s)||(i.uniform1iv(this.addr,s),_e(n,s));for(let o=0;o!==r;++o)e.setTexture2DArray(t[o]||Sl,s[o])}function Wp(i){switch(i){case 5126:return bp;case 35664:return Ap;case 35665:return wp;case 35666:return Rp;case 35674:return Cp;case 35675:return Pp;case 35676:return Lp;case 5124:case 35670:return Dp;case 35667:case 35671:return Ip;case 35668:case 35672:return Up;case 35669:case 35673:return Np;case 5125:return Fp;case 36294:return Op;case 36295:return Bp;case 36296:return zp;case 35678:case 36198:case 36298:case 36306:case 35682:return kp;case 35679:case 36299:case 36307:return Hp;case 35680:case 36300:case 36308:case 36293:return Vp;case 36289:case 36303:case 36311:case 36292:return Gp}}class Xp{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=Tp(e.type)}}class qp{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=Wp(e.type)}}class Yp{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(t,e[a.id],n)}}}const Ks=/(\w+)(\])?(\[|\.)?/g;function dc(i,t){i.seq.push(t),i.map[t.id]=t}function $p(i,t,e){const n=i.name,r=n.length;for(Ks.lastIndex=0;;){const s=Ks.exec(n),o=Ks.lastIndex;let a=s[1];const c=s[2]==="]",l=s[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===r){dc(e,l===void 0?new Xp(a,i,t):new qp(a,i,t));break}else{let p=e.map[a];p===void 0&&(p=new Yp(a),dc(e,p)),e=p}}}class ss{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=t.getActiveUniform(e,r),o=t.getUniformLocation(e,s.name);$p(s,o,this)}}setValue(t,e,n,r){const s=this.map[e];s!==void 0&&s.setValue(t,n,r)}setOptional(t,e,n){const r=e[n];r!==void 0&&this.setValue(t,n,r)}static upload(t,e,n,r){for(let s=0,o=e.length;s!==o;++s){const a=e[s],c=n[a.id];c.needsUpdate!==!1&&a.setValue(t,c.value,r)}}static seqWithValue(t,e){const n=[];for(let r=0,s=t.length;r!==s;++r){const o=t[r];o.id in e&&n.push(o)}return n}}function fc(i,t,e){const n=i.createShader(t);return i.shaderSource(n,e),i.compileShader(n),n}const Kp=37297;let Jp=0;function Zp(i,t){const e=i.split(`
`),n=[],r=Math.max(t-6,0),s=Math.min(t+6,e.length);for(let o=r;o<s;o++){const a=o+1;n.push(`${a===t?">":" "} ${a}: ${e[o]}`)}return n.join(`
`)}const pc=new Ut;function jp(i){$t._getMatrix(pc,$t.workingColorSpace,i);const t=`mat3( ${pc.elements.map(e=>e.toFixed(4))} )`;switch($t.getTransfer(i)){case fs:return[t,"LinearTransferOETF"];case te:return[t,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",i),[t,"LinearTransferOETF"]}}function mc(i,t,e){const n=i.getShaderParameter(t,i.COMPILE_STATUS),r=i.getShaderInfoLog(t).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return e.toUpperCase()+`
...
`)}function rm(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(t,r),o=s.name;let a=1;s.type===i.FLOAT_MAT2&&(a=2),s.type===i.FLOAT_MAT3&&(a=3),s.type===i.FLOAT_MAT4&&(a=4),e[o]={type:s.type,location:i.getAttribLocation(t,o),locationSize:a}}return e}function lr(i){return i!==""}function gc(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function _c(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const sm=/^[ \t]*#include +<([\w\d./]+)>/gm;function Ko(i){return i.replace(sm,am)}const om=new Map;function am(i,t){let e=Ft[t];if(e===void 0){const n=om.get(t);if(n!==void 0)e=Ft[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return Ko(e)}const cm=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function vc(i){return i.replace(cm,lm)}function lm(i,t,e,n){let r="";for(let s=parseInt(t);s<parseInt(e);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function xc(i){let t=`precision ${i.precision} float;
...
`].filter(lr).join(`
`)),o=Ko(o),o=gc(o,e),o=_c(o,e),a=Ko(a),a=gc(a,e),a=_c(a,e),o=vc(o),a=vc(a),e.isRawShaderMaterial!==!0&&(E=`#version 300 es
...
}`;function Im(i,t,e){let n=new la;const r=new pt,s=new pt,o=new he,a=new Cm({depthPacking:bu}),c=new Pm,l={},h=e.maxTextureSize,p={[jn]:Le,[Le]:jn,[Tn]:Tn},f=new pn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new pt},radius:{value:4}},vertexShader:Lm,fragmentShader:Dm}),d=f.clone();d.defines.HORIZONTAL_PASS=1;const g=new Ve;g.setAttribute("position",new hn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new Bt(g,f),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Wc;let u=this.type;this.render=function(w,A,R){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||w.length===0)return;const y=i.getRenderTarget(),M=i.getActiveCubeFace(),C=i.getActiveMipmapLevel(),k=i.state;k.setBlending(Jn),k.buffers.color.setClear(1,1,1,1),k.buffers.depth.setTest(!0),k.setScissorTest(!1);const z=u!==En&&this.type===En,X=u===En&&this.type!==En;for(let J=0,W=w.length;J<W;J++){const j=w[J],G=j.shadow;if(G===void 0){console.warn("THREE.WebGLShadowMap:",j,"has no shadow.");continue}if(G.autoUpdate===!1&&G.needsUpdate===!1)continue;r.copy(G.mapSize);const rt=G.getFrameExtents();if(r.multiply(rt),s.copy(G.mapSize),(r.x>h||r.y>h)&&(r.x>h&&(s.x=Math.floor(h/rt.x),r.x=s.x*rt.x,G.mapSize.x=s.x),r.y>h&&(s.y=Math.floor(h/rt.y),r.y=s.y*rt.y,G.mapSize.y=s.y)),G.map===null||z===!0||X===!0){const St=this.type!==En?{minFilter:on,magFilter:on}:{};G.map!==null&&G.map.dispose(),G.map=new vi(r.x,r.y,St),G.map.texture.name=j.name+".shadowMap",G.camera.updateProjectionMatrix()}i.setRenderTarget(G.map),i.clear();const ut=G.getViewportCount();for(let St=0;St<ut;St++){const Ht=G.getViewport(St);o.set(s.x*Ht.x,s.y*Ht.y,s.x*Ht.z,s.y*Ht.w),k.viewport(o),G.updateMatrices(j,St),n=G.getFrustum(),S(A,R,G.camera,j,this.type)}G.isPointLightShadow!==!0&&this.type===En&&E(G,R),G.needsUpdate=!1}u=this.type,m.needsUpdate=!1,i.setRenderTarget(y,M,C)};function E(w,A){const R=t.update(_);f.defines.VSM_SAMPLES!==w.blurSamples&&(f.defines.VSM_SAMPLES=w.blurSamples,d.defines.VSM_SAMPLES=w.blurSamples,f.needsUpdate=!0,d.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new vi(r.x,r.y)),f.uniforms.shadow_pass.value=w.map.texture,f.uniforms.resolution.value=w.mapSize,f.uniforms.radius.value=w.radius,i.setRenderTarget(w.mapPass),i.clear(),i.renderBufferDirect(A,null,R,f,_,null),d.uniforms.shadow_pass.value=w.mapPass.texture,d.uniforms.resolution.value=w.mapSize,d.uniforms.radius.value=w.radius,i.setRenderTarget(w.map),i.clear(),i.renderBufferDirect(A,null,R,d,_,null)}function T(w,A,R,y){let M=null;const C=R.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(C!==void 0)M=C;else if(M=R.isPointLight===!0?c:a,i.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0){const k=M.uuid,z=A.uuid;let X=l[k];X===void 0&&(X={},l[k]=X);let J=X[z];J===void 0&&(J=M.clone(),X[z]=J,A.addEventListener("dispose",N)),M=J}if(M.visible=A.visible,M.wireframe=A.wireframe,y===En?M.side=A.shadowSide!==null?A.shadowSide:A.side:M.side=A.shadowSide!==null?A.shadowSide:p[A.side],M.alphaMap=A.alphaMap,M.alphaTest=A.alphaTest,M.map=A.map,M.clipShadows=A.clipShadows,M.clippingPlanes=A.clippingPlanes,M.clipIntersection=A.clipIntersection,M.displacementMap=A.displacementMap,M.displacementScale=A.displacementScale,M.displacementBias=A.displacementBias,M.wireframeLinewidth=A.wireframeLinewidth,M.linewidth=A.linewidth,R.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const k=i.properties.get(M);k.light=R}return M}function S(w,A,R,y,M){if(w.visible===!1)return;if(w.layers.test(A.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&M===En)&&(!w.frustumCulled||n.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(R.matrixWorldInverse,w.matrixWorld);const z=t.update(w),X=w.material;if(Array.isArray(X)){const J=z.groups;for(let W=0,j=J.length;W<j;W++){const G=J[W],rt=X[G.materialIndex];if(rt&&rt.visible){const ut=T(w,rt,y,M);w.onBeforeShadow(i,w,A,R,z,ut,G),i.renderBufferDirect(R,null,z,ut,w,G),w.onAfterShadow(i,w,A,R,z,ut,G)}}}else if(X.visible){const J=T(w,X,y,M);w.onBeforeShadow(i,w,A,R,z,J,null),i.renderBufferDirect(R,null,z,J,w,null),w.onAfterShadow(i,w,A,R,z,J,null)}}const k=w.children;for(let z=0,X=k.length;z<X;z++)S(k[z],A,R,y,M)}function N(w){w.target.removeEventListener("dispose",N);for(const R in l){const y=l[R],M=w.target.uuid;M in y&&(y[M].dispose(),delete y[M])}}}const Um={[uo]:ho,[fo]:go,[po]:_o,[Hi]:mo,[ho]:uo,[go]:fo,[_o]:po,[mo]:Hi};function Nm(i,t){function e(){let L=!1;const it=new he;let H=null;const K=new he(0,0,0,0);return{setMask:function(lt){H!==lt&&!L&&(i.colorMask(lt,lt,lt,lt),H=lt)},setLocked:function(lt){L=lt},setClear:function(lt,at,Dt,le,Te){Te===!0&&(lt*=le,at*=le,Dt*=le),it.set(lt,at,Dt,le),K.equals(it)===!1&&(i.clearColor(lt,at,Dt,le),K.copy(it))},reset:function(){L=!1,H=null,K.set(-1,0,0,0)}}}function n(){let L=!1,it=!1,H=null,K=null,lt=null;return{setReversed:function(at){if(it!==at){const Dt=t.get("EXT_clip_control");it?Dt.clipControlEXT(Dt.LOWER_LEFT_EXT,Dt.ZERO_TO_ONE_EXT):Dt.clipControlEXT(Dt.LOWER_LEFT_EXT,Dt.NEGATIVE_ONE_TO_ONE_EXT);const le=lt;lt=null,this.setClear(le)}it=at},getReversed:function(){return it},setTest:function(at){at?st(i.DEPTH_TEST):At(i.DEPTH_TEST)},setMask:function(at){H!==at&&!L&&(i.depthMask(at),H=at)},setFunc:function(at){if(it&&(at=Um[at]),K!==at){switch(at){case uo:i.depthFunc(i.NEVER);break;case ho:i.depthFunc(i.ALWAYS);break;case fo:i.depthFunc(i.LESS);break;case Hi:i.depthFunc(i.LEQUAL);break;case po:i.depthFunc(i.EQUAL);break;case mo:i.depthFunc(i.GEQUAL);break;case go:i.depthFunc(i.GREATER);break;case _o:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}K=at}},setLocked:function(at){L=at},setClear:function(at){lt!==at&&(it&&(at=1-at),i.clearDepth(at),lt=at)},reset:function(){L=!1,H=null,K=null,lt=null,it=!1}}}function r(){let L=!1,it=null,H=null,K=null,lt=null,at=null,Dt=null,le=null,Te=null;return{setTest:function(Qt){L||(Qt?st(i.STENCIL_TEST):At(i.STENCIL_TEST))},setMask:function(Qt){it!==Qt&&!L&&(i.stencilMask(Qt),it=Qt)},setFunc:function(Qt,$e,gn){(H!==Qt||K!==$e||lt!==gn)&&(i.stencilFunc(Qt,$e,gn),H=Qt,K=$e,lt=gn)},setOp:function(Qt,$e,gn){(at!==Qt||Dt!==$e||le!==gn)&&(i.stencilOp(Qt,$e,gn),at=Qt,Dt=$e,le=gn)},setLocked:function(Qt){L=Qt},setClear:function(Qt){Te!==Qt&&(i.clearStencil(Qt),Te=Qt)},reset:function(){L=!1,it=null,H=null,K=null,lt=null,at=null,Dt=null,le=null,Te=null}}}const s=new e,o=new n,a=new r,c=new WeakMap,l=new WeakMap;let h={},p={},f=new WeakMap,d=[],g=null,_=!1,m=null,u=null,E=null,T=null,S=null,N=null,w=null,A=new Et(0,0,0),R=0,y=!1,M=null,C=null,k=null,z=null,X=null;const J=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let W=!1,j=0;const G=i.getParameter(i.VERSION);G.indexOf("WebGL")!==-1?(j=parseFloat(/^WebGL (\d)/.exec(G)[1]),W=j>=1):G.indexOf("OpenGL ES")!==-1&&(j=parseFloat(/^OpenGL ES (\d)/.exec(G)[1]),W=j>=2);let rt=null,ut={};const St=i.getParameter(i.SCISSOR_BOX),Ht=i.getParameter(i.VIEWPORT),ee=new he().fromArray(St),Y=new he().fromArray(Ht);function et(L,it,H,K){const lt=new Uint8Array(4),at=i.createTexture();i.bindTexture(L,at),i.texParameteri(L,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(L,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Dt=0;Dt<H;Dt++)L===i.TEXTURE_3D||L===i.TEXTURE_2D_ARRAY?i.texImage3D(it,0,i.RGBA,1,1,K,0,i.RGBA,i.UNSIGNED_BYTE,lt):i.texImage2D(it+Dt,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,lt);return at}const vt={};vt[i.TEXTURE_2D]=et(i.TEXTURE_2D,i.TEXTURE_2D,1),vt[i.TEXTURE_CUBE_MAP]=et(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),vt[i.TEXTURE_2D_ARRAY]=et(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),vt[i.TEXTURE_3D]=et(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),st(i.DEPTH_TEST),o.setFunc(Hi),Gt(!1),Wt(Aa),st(i.CULL_FACE),U(Jn);function st(L){h[L]!==!0&&(i.enable(L),h[L]=!0)}function At(L){h[L]!==!1&&(i.disable(L),h[L]=!1)}function Lt(L,it){return p[L]!==it?(i.bindFramebuffer(L,it),p[L]=it,L===i.DRAW_FRAMEBUFFER&&(p[i.FRAMEBUFFER]=it),L===i.FRAMEBUFFER&&(p[i.DRAW_FRAMEBUFFER]=it),!0):!1}function Vt(L,it){let H=d,K=!1;if(L){H=f.get(it),H===void 0&&(H=[],f.set(it,H));const lt=L.textures;if(H.length!==lt.length||H[0]!==i.COLOR_ATTACHMENT0){for(let at=0,Dt=lt.length;at<Dt;at++)H[at]=i.COLOR_ATTACHMENT0+at;H.length=lt.length,K=!0}}else H[0]!==i.BACK&&(H[0]=i.BACK,K=!0);K&&i.drawBuffers(H)}function ce(L){return g!==L?(i.useProgram(L),g=L,!0):!1}const qt={[di]:i.FUNC_ADD,[jl]:i.FUNC_SUBTRACT,[Ql]:i.FUNC_REVERSE_SUBTRACT};qt[tu]=i.MIN,qt[eu]=i.MAX;const de={[nu]:i.ZERO,[iu]:i.ONE,[ru]:i.SRC_COLOR,[co]:i.SRC_ALPHA,[uu]:i.SRC_ALPHA_SATURATE,[cu]:i.DST_COLOR,[ou]:i.DST_ALPHA,[su]:i.ONE_MINUS_SRC_COLOR,[lo]:i.ONE_MINUS_SRC_ALPHA,[lu]:i.ONE_MINUS_DST_COLOR,[au]:i.ONE_MINUS_DST_ALPHA,[hu]:i.CONSTANT_COLOR,[du]:i.ONE_MINUS_CONSTANT_COLOR,[fu]:i.CONSTANT_ALPHA,[pu]:i.ONE_MINUS_CONSTANT_ALPHA};function U(L,it,H,K,lt,at,Dt,le,Te,Qt){if(L===Jn){_===!0&&(At(i.BLEND),_=!1);return}if(_===!1&&(st(i.BLEND),_=!0),L!==Zl){if(L!==m||Qt!==y){if((u!==di||S!==di)&&(i.blendEquation(i.FUNC_ADD),u=di,S=di),Qt)switch(L){case Bi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case wa:i.blendFunc(i.ONE,i.ONE);break;case Ra:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Ca:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}else switch(L){case Bi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case wa:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case Ra:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Ca:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}E=null,T=null,N=null,w=null,A.set(0,0,0),R=0,m=L,y=Qt}return}lt=lt||it,at=at||H,Dt=Dt||K,(it!==u||lt!==S)&&(i.blendEquationSeparate(qt[it],qt[lt]),u=it,S=lt),(H!==E||K!==T||at!==N||Dt!==w)&&(i.blendFuncSeparate(de[H],de[K],de[at],de[Dt]),E=H,T=K,N=at,w=Dt),(le.equals(A)===!1||Te!==R)&&(i.blendColor(le.r,le.g,le.b,Te),A.copy(le),R=Te),m=L,y=!1}function Ge(L,it){L.side===Tn?At(i.CULL_FACE):st(i.CULL_FACE);let H=L.side===Le;it&&(H=!H),Gt(H),L.blending===Bi&&L.transparent===!1?U(Jn):U(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),o.setFunc(L.depthFunc),o.setTest(L.depthTest),o.setMask(L.depthWrite),s.setMask(L.colorWrite);const K=L.stencilWrite;a.setTest(K),K&&(a.setMask(L.stencilWriteMask),a.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),a.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),re(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?st(i.SAMPLE_ALPHA_TO_COVERAGE):At(i.SAMPLE_ALPHA_TO_COVERAGE)}function Gt(L){M!==L&&(L?i.frontFace(i.CW):i.frontFace(i.CCW),M=L)}function Wt(L){L!==Kl?(st(i.CULL_FACE),L!==C&&(L===Aa?i.cullFace(i.BACK):L===Jl?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):At(i.CULL_FACE),C=L}function Tt(L){L!==k&&(W&&i.lineWidth(L),k=L)}function re(L,it,H){L?(st(i.POLYGON_OFFSET_FILL),(z!==it||X!==H)&&(i.polygonOffset(it,H),z=it,X=H)):At(i.POLYGON_OFFSET_FILL)}function yt(L){L?st(i.SCISSOR_TEST):At(i.SCISSOR_TEST)}function b(L){L===void 0&&(L=i.TEXTURE0+J-1),rt!==L&&(i.activeTexture(L),rt=L)}function v(L,it,H){H===void 0&&(rt===null?H=i.TEXTURE0+J-1:H=rt);let K=ut[H];K===void 0&&(K={type:void 0,texture:void 0},ut[H]=K),(K.type!==L||K.texture!==it)&&(rt!==H&&(i.activeTexture(H),rt=H),i.bindTexture(L,it||vt[L]),K.type=L,K.texture=it)}function F(){const L=ut[rt];L!==void 0&&L.type!==void 0&&(i.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function $(){try{i.compressedTexImage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Z(){try{i.compressedTexImage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function q(){try{i.texSubImage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function xt(){try{i.texSubImage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ot(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ht(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Yt(){try{i.texStorage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Q(){try{i.texStorage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function dt(){try{i.texImage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function bt(){try{i.texImage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Rt(L){ee.equals(L)===!1&&(i.scissor(L.x,L.y,L.z,L.w),ee.copy(L))}function ft(L){Y.equals(L)===!1&&(i.viewport(L.x,L.y,L.z,L.w),Y.copy(L))}function Xt(L,it){let H=l.get(it);H===void 0&&(H=new WeakMap,l.set(it,H));let K=H.get(L);K===void 0&&(K=i.getUniformBlockIndex(it,L.name),H.set(L,K))}function Nt(L,it){const K=l.get(it).get(L);c.get(it)!==K&&(i.uniformBlockBinding(it,K,L.__bindingPointIndex),c.set(it,K))}function ne(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),o.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),h={},rt=null,ut={},p={},f=new WeakMap,d=[],g=null,_=!1,m=null,u=null,E=null,T=null,S=null,N=null,w=null,A=new Et(0,0,0),R=0,y=!1,M=null,C=null,k=null,z=null,X=null,ee.set(0,0,i.canvas.width,i.canvas.height),Y.set(0,0,i.canvas.width,i.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:st,disable:At,bindFramebuffer:Lt,drawBuffers:Vt,useProgram:ce,setBlending:U,setMaterial:Ge,setFlipSided:Gt,setCullFace:Wt,setLineWidth:Tt,setPolygonOffset:re,setScissorTest:yt,activeTexture:b,bindTexture:v,unbindTexture:F,compressedTexImage2D:$,compressedTexImage3D:Z,texImage2D:dt,texImage3D:bt,updateUBOMapping:Xt,uniformBlockBinding:Nt,texStorage2D:Yt,texStorage3D:Q,texSubImage2D:q,texSubImage3D:xt,compressedTexSubImage2D:ot,compressedTexSubImage3D:ht,scissor:Rt,viewport:ft,reset:ne}}function Ec(i,t,e,n){const r=Fm(n);switch(e){case Zc:return i*t;case Qc:return i*t;case tl:return i*t*2;case el:return i*t/r.components*r.byteLength;case oa:return i*t/r.components*r.byteLength;case nl:return i*t*2/r.components*r.byteLength;case aa:return i*t*2/r.components*r.byteLength;case jc:return i*t*3/r.components*r.byteLength;case nn:return i*t*4/r.components*r.byteLength;case ca:return i*t*4/r.components*r.byteLength;case ts:case es:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*8;case ns:case is:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*16;case Eo:case bo:return Math.max(i,16)*Math.max(t,8)/4;case yo:case To:return Math.max(i,8)*Math.max(t,8)/2;case Ao:case wo:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*8;case Ro:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*16;case Co:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*16;case Po:return Math.floor((i+4)/5)*Math.floor((t+3)/4)*16;case Lo:return Math.floor((i+4)/5)*Math.floor((t+4)/5)*16;case Do:return Math.floor((i+5)/6)*Math.floor((t+4)/5)*16;case Io:return Math.floor((i+5)/6)*Math.floor((t+5)/6)*16;case Uo:return Math.floor((i+7)/8)*Math.floor((t+4)/5)*16;case No:return Math.floor((i+7)/8)*Math.floor((t+5)/6)*16;case Fo:return Math.floor((i+7)/8)*Math.floor((t+7)/8)*16;case Oo:return Math.floor((i+9)/10)*Math.floor((t+4)/5)*16;case Bo:return Math.floor((i+9)/10)*Math.floor((t+5)/6)*16;case zo:return Math.floor((i+9)/10)*Math.floor((t+7)/8)*16;case ko:return Math.floor((i+9)/10)*Math.floor((t+9)/10)*16;case Ho:return Math.floor((i+11)/12)*Math.floor((t+9)/10)*16;case Vo:return Math.floor((i+11)/12)*Math.floor((t+11)/12)*16;case rs:case Go:case Wo:return Math.ceil(i/4)*Math.ceil(t/4)*16;case il:case Xo:return Math.ceil(i/4)*Math.ceil(t/4)*8;case qo:case Yo:return Math.ceil(i/4)*Math.ceil(t/4)*16}throw new Error(`Unable to determine texture byte length for ${e} format.`)}function Fm(i){switch(i){case In:case $c:return{byteLength:1,components:1};case mr:case Kc:case vr:return{byteLength:2,components:1};case ra:case sa:return{byteLength:2,components:4};case _i:case ia:case wn:return{byteLength:4,components:1};case Jc:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${i}.`)}function Om(i,t,e,n,r,s,o){const a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new pt,h=new WeakMap;let p;const f=new WeakMap;let d=!1;try{d=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(b,v){return d?new OffscreenCanvas(b,v):cs("canvas")}function _(b,v,F){let $=1;const Z=yt(b);if((Z.width>F||Z.height>F)&&($=F/Math.max(Z.width,Z.height)),$<1)if(typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&b instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&b instanceof ImageBitmap||typeof VideoFrame<"u"&&b instanceof VideoFrame){const q=Math.floor($*Z.width),xt=Math.floor($*Z.height);p===void 0&&(p=g(q,xt));const ot=v?g(q,xt):p;return ot.width=q,ot.height=xt,ot.getContext("2d").drawImage(b,0,0,q,xt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+Z.width+"x"+Z.height+") to ("+q+"x"+xt+")."),ot}else return"data"in b&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+Z.width+"x"+Z.height+")."),b;return b}function m(b){return b.generateMipmaps}function u(b){i.generateMipmap(b)}function E(b){return b.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:b.isWebGL3DRenderTarget?i.TEXTURE_3D:b.isWebGLArrayRenderTarget||b.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function T(b,v,F,$,Z=!1){if(b!==null){if(i[b]!==void 0)return i[b];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+b+"'")}let q=v;if(v===i.RED&&(F===i.FLOAT&&(q=i.R32F),F===i.HALF_FLOAT&&(q=i.R16F),F===i.UNSIGNED_BYTE&&(q=i.R8)),v===i.RED_INTEGER&&(F===i.UNSIGNED_BYTE&&(q=i.R8UI),F===i.UNSIGNED_SHORT&&(q=i.R16UI),F===i.UNSIGNED_INT&&(q=i.R32UI),F===i.BYTE&&(q=i.R8I),F===i.SHORT&&(q=i.R16I),F===i.INT&&(q=i.R32I)),v===i.RG&&(F===i.FLOAT&&(q=i.RG32F),F===i.HALF_FLOAT&&(q=i.RG16F),F===i.UNSIGNED_BYTE&&(q=i.RG8)),v===i.RG_INTEGER&&(F===i.UNSIGNED_BYTE&&(q=i.RG8UI),F===i.UNSIGNED_SHORT&&(q=i.RG16UI),F===i.UNSIGNED_INT&&(q=i.RG32UI),F===i.BYTE&&(q=i.RG8I),F===i.SHORT&&(q=i.RG16I),F===i.INT&&(q=i.RG32I)),v===i.RGB_INTEGER&&(F===i.UNSIGNED_BYTE&&(q=i.RGB8UI),F===i.UNSIGNED_SHORT&&(q=i.RGB16UI),F===i.UNSIGNED_INT&&(q=i.RGB32UI),F===i.BYTE&&(q=i.RGB8I),F===i.SHORT&&(q=i.RGB16I),F===i.INT&&(q=i.RGB32I)),v===i.RGBA_INTEGER&&(F===i.UNSIGNED_BYTE&&(q=i.RGBA8UI),F===i.UNSIGNED_SHORT&&(q=i.RGBA16UI),F===i.UNSIGNED_INT&&(q=i.RGBA32UI),F===i.BYTE&&(q=i.RGBA8I),F===i.SHORT&&(q=i.RGBA16I),F===i.INT&&(q=i.RGBA32I)),v===i.RGB&&F===i.UNSIGNED_INT_5_9_9_9_REV&&(q=i.RGB9_E5),v===i.RGBA){const xt=Z?fs:$t.getTransfer($);F===i.FLOAT&&(q=i.RGBA32F),F===i.HALF_FLOAT&&(q=i.RGBA16F),F===i.UNSIGNED_BYTE&&(q=xt===te?i.SRGB8_ALPHA8:i.RGBA8),F===i.UNSIGNED_SHORT_4_4_4_4&&(q=i.RGBA4),F===i.UNSIGNED_SHORT_5_5_5_1&&(q=i.RGB5_A1)}return(q===i.R16F||q===i.R32F||q===i.RG16F||q===i.RG32F||q===i.RGBA16F||q===i.RGBA32F)&&t.get("EXT_color_buffer_float"),q}function S(b,v){let F;return b?v===null||v===_i||v===Wi?F=i.DEPTH24_STENCIL8:v===wn?F=i.DEPTH32F_STENCIL8:v===mr&&(F=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===_i||v===Wi?F=i.DEPTH_COMPONENT24:v===wn?F=i.DEPTH_COMPONENT32F:v===mr&&(F=i.DEPTH_COMPONENT16),F}function N(b,v){return m(b)===!0||b.isFramebufferTexture&&b.minFilter!==on&&b.minFilter!==un?Math.log2(Math.max(v.width,v.height))+1:b.mipmaps!==void 0&&b.mipmaps.length>0?b.mipmaps.length:b.isCompressedTexture&&Array.isArray(b.image)?v.mipmaps.length:1}function w(b){const v=b.target;v.removeEventListener("dispose",w),R(v),v.isVideoTexture&&h.delete(v)}function A(b){const v=b.target;v.removeEventListener("dispose",A),M(v)}function R(b){const v=n.get(b);if(v.__webglInit===void 0)return;const F=b.source,$=f.get(F);if($){const Z=$[v.__cacheKey];Z.usedTimes--,Z.usedTimes===0&&y(b),Object.keys($).length===0&&f.delete(F)}n.remove(b)}function y(b){const v=n.get(b);i.deleteTexture(v.__webglTexture);const F=b.source,$=f.get(F);delete $[v.__cacheKey],o.memory.textures--}function M(b){const v=n.get(b);if(b.depthTexture&&(b.depthTexture.dispose(),n.remove(b.depthTexture)),b.isWebGLCubeRenderTarget)for(let $=0;$<6;$++){if(Array.isArray(v.__webglFramebuffer[$]))for(let Z=0;Z<v.__webglFramebuffer[$].length;Z++)i.deleteFramebuffer(v.__webglFramebuffer[$][Z]);else i.deleteFramebuffer(v.__webglFramebuffer[$]);v.__webglDepthbuffer&&i.deleteRenderbuffer(v.__webglDepthbuffer[$])}else{if(Array.isArray(v.__webglFramebuffer))for(let $=0;$<v.__webglFramebuffer.length;$++)i.deleteFramebuffer(v.__webglFramebuffer[$]);else i.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&i.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&i.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let $=0;$<v.__webglColorRenderbuffer.length;$++)v.__webglColorRenderbuffer[$]&&i.deleteRenderbuffer(v.__webglColorRenderbuffer[$]);v.__webglDepthRenderbuffer&&i.deleteRenderbuffer(v.__webglDepthRenderbuffer)}const F=b.textures;for(let $=0,Z=F.length;$<Z;$++){const q=n.get(F[$]);q.__webglTexture&&(i.deleteTexture(q.__webglTexture),o.memory.textures--),n.remove(F[$])}n.remove(b)}let C=0;function k(){C=0}function z(){const b=C;return b>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+b+" texture units while this GPU supports only "+r.maxTextures),C+=1,b}function X(b){const v=[];return v.push(b.wrapS),v.push(b.wrapT),v.push(b.wrapR||0),v.push(b.magFilter),v.push(b.minFilter),v.push(b.anisotropy),v.push(b.internalFormat),v.push(b.format),v.push(b.type),v.push(b.generateMipmaps),v.push(b.premultiplyAlpha),v.push(b.flipY),v.push(b.unpackAlignment),v.push(b.colorSpace),v.join()}function J(b,v){const F=n.get(b);if(b.isVideoTexture&&Tt(b),b.isRenderTargetTexture===!1&&b.version>0&&F.__version!==b.version){const $=b.image;if($===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if($.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Y(F,b,v);return}}e.bindTexture(i.TEXTURE_2D,F.__webglTexture,i.TEXTURE0+v)}function W(b,v){const F=n.get(b);if(b.version>0&&F.__version!==b.version){Y(F,b,v);return}e.bindTexture(i.TEXTURE_2D_ARRAY,F.__webglTexture,i.TEXTURE0+v)}function j(b,v){const F=n.get(b);if(b.version>0&&F.__version!==b.version){Y(F,b,v);return}e.bindTexture(i.TEXTURE_3D,F.__webglTexture,i.TEXTURE0+v)}function G(b,v){const F=n.get(b);if(b.version>0&&F.__version!==b.version){et(F,b,v);return}e.bindTexture(i.TEXTURE_CUBE_MAP,F.__webglTexture,i.TEXTURE0+v)}const rt={[Mo]:i.REPEAT,[pi]:i.CLAMP_TO_EDGE,[So]:i.MIRRORED_REPEAT},ut={[on]:i.NEAREST,[Eu]:i.NEAREST_MIPMAP_NEAREST,[br]:i.NEAREST_MIPMAP_LINEAR,[un]:i.LINEAR,[Ss]:i.LINEAR_MIPMAP_NEAREST,[mi]:i.LINEAR_MIPMAP_LINEAR},St={[wu]:i.NEVER,[Iu]:i.ALWAYS,[Ru]:i.LESS,[sl]:i.LEQUAL,[Cu]:i.EQUAL,[Du]:i.GEQUAL,[Pu]:i.GREATER,[Lu]:i.NOTEQUAL};function Ht(b,v){if(v.type===wn&&t.has("OES_texture_float_linear")===!1&&(v.magFilter===un||v.magFilter===Ss||v.magFilter===br||v.magFilter===mi||v.minFilter===un||v.minFilter===Ss||v.minFilter===br||v.minFilter===mi)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(b,i.TEXTURE_WRAP_S,rt[v.wrapS]),i.texParameteri(b,i.TEXTURE_WRAP_T,rt[v.wrapT]),(b===i.TEXTURE_3D||b===i.TEXTURE_2D_ARRAY)&&i.texParameteri(b,i.TEXTURE_WRAP_R,rt[v.wrapR]),i.texParameteri(b,i.TEXTURE_MAG_FILTER,ut[v.magFilter]),i.texParameteri(b,i.TEXTURE_MIN_FILTER,ut[v.minFilter]),v.compareFunction&&(i.texParameteri(b,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(b,i.TEXTURE_COMPARE_FUNC,St[v.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===on||v.minFilter!==br&&v.minFilter!==mi||v.type===wn&&t.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||n.get(v).__currentAnisotropy){const F=t.get("EXT_texture_filter_anisotropic");i.texParameterf(b,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,r.getMaxAnisotropy())),n.get(v).__currentAnisotropy=v.anisotropy}}}function ee(b,v){let F=!1;b.__webglInit===void 0&&(b.__webglInit=!0,v.addEventListener("dispose",w));const $=v.source;let Z=f.get($);Z===void 0&&(Z={},f.set($,Z));const q=X(v);if(q!==b.__cacheKey){Z[q]===void 0&&(Z[q]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,F=!0),Z[q].usedTimes++;const xt=Z[b.__cacheKey];xt!==void 0&&(Z[b.__cacheKey].usedTimes--,xt.usedTimes===0&&y(v)),b.__cacheKey=q,b.__webglTexture=Z[q].texture}return F}function Y(b,v,F){let $=i.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&($=i.TEXTURE_2D_ARRAY),v.isData3DTexture&&($=i.TEXTURE_3D);const Z=ee(b,v),q=v.source;e.bindTexture($,b.__webglTexture,i.TEXTURE0+F);const xt=n.get(q);if(q.version!==xt.__version||Z===!0){e.activeTexture(i.TEXTURE0+F);const ot=$t.getPrimaries($t.workingColorSpace),ht=v.colorSpace===Xn?null:$t.getPrimaries(v.colorSpace),Yt=v.colorSpace===Xn||ot===ht?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,v.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,v.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Yt);let Q=_(v.image,!1,r.maxTextureSize);Q=re(v,Q);const dt=s.convert(v.format,v.colorSpace),bt=s.convert(v.type);let Rt=T(v.internalFormat,dt,bt,v.colorSpace,v.isVideoTexture);Ht($,v);let ft;const Xt=v.mipmaps,Nt=v.isVideoTexture!==!0,ne=xt.__version===void 0||Z===!0,L=q.dataReady,it=N(v,Q);if(v.isDepthTexture)Rt=S(v.format===Xi,v.type),ne&&(Nt?e.texStorage2D(i.TEXTURE_2D,1,Rt,Q.width,Q.height):e.texImage2D(i.TEXTURE_2D,0,Rt,Q.width,Q.height,0,dt,bt,null));else if(v.isDataTexture)if(Xt.length>0){Nt&&ne&&e.texStorage2D(i.TEXTURE_2D,it,Rt,Xt[0].width,Xt[0].height);for(let H=0,K=Xt.length;H<K;H++)ft=Xt[H],Nt?L&&e.texSubImage2D(i.TEXTURE_2D,H,0,0,ft.width,ft.height,dt,bt,ft.data):e.texImage2D(i.TEXTURE_2D,H,Rt,ft.width,ft.height,0,dt,bt,ft.data);v.generateMipmaps=!1}else Nt?(ne&&e.texStorage2D(i.TEXTURE_2D,it,Rt,Q.width,Q.height),L&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,Q.width,Q.height,dt,bt,Q.data)):e.texImage2D(i.TEXTURE_2D,0,Rt,Q.width,Q.height,0,dt,bt,Q.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){Nt&&ne&&e.texStorage3D(i.TEXTURE_2D_ARRAY,it,Rt,Xt[0].width,Xt[0].height,Q.depth);for(let H=0,K=Xt.length;H<K;H++)if(ft=Xt[H],v.format!==nn)if(dt!==null)if(Nt){if(L)if(v.layerUpdates.size>0){const lt=Ec(ft.width,ft.height,v.format,v.type);for(const at of v.layerUpdates){const Dt=ft.data.subarray(at*lt/ft.data.BYTES_PER_ELEMENT,(at+1)*lt/ft.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,H,0,0,at,ft.width,ft.height,1,dt,Dt)}v.clearLayerUpdates()}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,H,0,0,0,ft.width,ft.height,Q.depth,dt,ft.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,H,Rt,ft.width,ft.height,Q.depth,0,ft.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Nt?L&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,H,0,0,0,ft.width,ft.height,Q.depth,dt,bt,ft.data):e.texImage3D(i.TEXTURE_2D_ARRAY,H,Rt,ft.width,ft.height,Q.depth,0,dt,bt,ft.data)}else{Nt&&ne&&e.texStorage2D(i.TEXTURE_2D,it,Rt,Xt[0].width,Xt[0].height);for(let H=0,K=Xt.length;H<K;H++)ft=Xt[H],v.format!==nn?dt!==null?Nt?L&&e.compressedTexSubImage2D(i.TEXTURE_2D,H,0,0,ft.width,ft.height,dt,ft.data):e.compressedTexImage2D(i.TEXTURE_2D,H,Rt,ft.width,ft.height,0,ft.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Nt?L&&e.texSubImage2D(i.TEXTURE_2D,H,0,0,ft.width,ft.height,dt,bt,ft.data):e.texImage2D(i.TEXTURE_2D,H,Rt,ft.width,ft.height,0,dt,bt,ft.data)}else if(v.isDataArrayTexture)if(Nt){if(ne&&e.texStorage3D(i.TEXTURE_2D_ARRAY,it,Rt,Q.width,Q.height,Q.depth),L)if(v.layerUpdates.size>0){const H=Ec(Q.width,Q.height,v.format,v.type);for(const K of v.layerUpdates){const lt=Q.data.subarray(K*H/Q.data.BYTES_PER_ELEMENT,(K+1)*H/Q.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,K,Q.width,Q.height,1,dt,bt,lt)}v.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,Q.width,Q.height,Q.depth,dt,bt,Q.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,Rt,Q.width,Q.height,Q.depth,0,dt,bt,Q.data);else if(v.isData3DTexture)Nt?(ne&&e.texStorage3D(i.TEXTURE_3D,it,Rt,Q.width,Q.height,Q.depth),L&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,Q.width,Q.height,Q.depth,dt,bt,Q.data)):e.texImage3D(i.TEXTURE_3D,0,Rt,Q.width,Q.height,Q.depth,0,dt,bt,Q.data);else if(v.isFramebufferTexture){if(ne)if(Nt)e.texStorage2D(i.TEXTURE_2D,it,Rt,Q.width,Q.height);else{let H=Q.width,K=Q.height;for(let lt=0;lt<it;lt++)e.texImage2D(i.TEXTURE_2D,lt,Rt,H,K,0,dt,bt,null),H>>=1,K>>=1}}else if(Xt.length>0){if(Nt&&ne){const H=yt(Xt[0]);e.texStorage2D(i.TEXTURE_2D,it,Rt,H.width,H.height)}for(let H=0,K=Xt.length;H<K;H++)ft=Xt[H],Nt?L&&e.texSubImage2D(i.TEXTURE_2D,H,0,0,dt,bt,ft):e.texImage2D(i.TEXTURE_2D,H,Rt,dt,bt,ft);v.generateMipmaps=!1}else if(Nt){if(ne){const H=yt(Q);e.texStorage2D(i.TEXTURE_2D,it,Rt,H.width,H.height)}L&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,dt,bt,Q)}else e.texImage2D(i.TEXTURE_2D,0,Rt,dt,bt,Q);m(v)&&u($),xt.__version=q.version,v.onUpdate&&v.onUpdate(v)}b.__version=v.version}function et(b,v,F){if(v.image.length!==6)return;const $=ee(b,v),Z=v.source;e.bindTexture(i.TEXTURE_CUBE_MAP,b.__webglTexture,i.TEXTURE0+F);const q=n.get(Z);if(Z.version!==q.__version||$===!0){e.activeTexture(i.TEXTURE0+F);const xt=$t.getPrimaries($t.workingColorSpace),ot=v.colorSpace===Xn?null:$t.getPrimaries(v.colorSpace),ht=v.colorSpace===Xn||xt===ot?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,v.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,v.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ht);const Yt=v.isCompressedTexture||v.image[0].isCompressedTexture,Q=v.image[0]&&v.image[0].isDataTexture,dt=[];for(let K=0;K<6;K++)!Yt&&!Q?dt[K]=_(v.image[K],!0,r.maxCubemapSize):dt[K]=Q?v.image[K].image:v.image[K],dt[K]=re(v,dt[K]);const bt=dt[0],Rt=s.convert(v.format,v.colorSpace),ft=s.convert(v.type),Xt=T(v.internalFormat,Rt,ft,v.colorSpace),Nt=v.isVideoTexture!==!0,ne=q.__version===void 0||$===!0,L=Z.dataReady;let it=N(v,bt);Ht(i.TEXTURE_CUBE_MAP,v);let H;if(Yt){Nt&&ne&&e.texStorage2D(i.TEXTURE_CUBE_MAP,it,Xt,bt.width,bt.height);for(let K=0;K<6;K++){H=dt[K].mipmaps;for(let lt=0;lt<H.length;lt++){const at=H[lt];v.format!==nn?Rt!==null?Nt?L&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,lt,0,0,at.width,at.height,Rt,at.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,lt,Xt,at.width,at.height,0,at.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Nt?L&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,lt,0,0,at.width,at.height,Rt,ft,at.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,lt,Xt,at.width,at.height,0,Rt,ft,at.data)}}}else{if(H=v.mipmaps,Nt&&ne){H.length>0&&it++;const K=yt(dt[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,it,Xt,K.width,K.height)}for(let K=0;K<6;K++)if(Q){Nt?L&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,dt[K].width,dt[K].height,Rt,ft,dt[K].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Xt,dt[K].width,dt[K].height,0,Rt,ft,dt[K].data);for(let lt=0;lt<H.length;lt++){const Dt=H[lt].image[K].image;Nt?L&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,lt+1,0,0,Dt.width,Dt.height,Rt,ft,Dt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,lt+1,Xt,Dt.width,Dt.height,0,Rt,ft,Dt.data)}}else{Nt?L&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,Rt,ft,dt[K]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Xt,Rt,ft,dt[K]);for(let lt=0;lt<H.length;lt++){const at=H[lt];Nt?L&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,lt+1,0,0,Rt,ft,at.image[K]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,lt+1,Xt,Rt,ft,at.image[K])}}}m(v)&&u(i.TEXTURE_CUBE_MAP),q.__version=Z.version,v.onUpdate&&v.onUpdate(v)}b.__version=v.version}function vt(b,v,F,$,Z,q){const xt=s.convert(F.format,F.colorSpace),ot=s.convert(F.type),ht=T(F.internalFormat,xt,ot,F.colorSpace),Yt=n.get(v),Q=n.get(F);if(Q.__renderTarget=v,!Yt.__hasExternalTextures){const dt=Math.max(1,v.width>>q),bt=Math.max(1,v.height>>q);Z===i.TEXTURE_3D||Z===i.TEXTURE_2D_ARRAY?e.texImage3D(Z,q,ht,dt,bt,v.depth,0,xt,ot,null):e.texImage2D(Z,q,ht,dt,bt,0,xt,ot,null)}e.bindFramebuffer(i.FRAMEBUFFER,b),Wt(v)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,$,Z,Q.__webglTexture,0,Gt(v)):(Z===i.TEXTURE_2D||Z>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Z<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,$,Z,Q.__webglTexture,q),e.bindFramebuffer(i.FRAMEBUFFER,null)}function st(b,v,F){if(i.bindRenderbuffer(i.RENDERBUFFER,b),v.depthBuffer){const $=v.depthTexture,Z=$&&$.isDepthTexture?$.type:null,q=S(v.stencilBuffer,Z),xt=v.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ot=Gt(v);Wt(v)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ot,q,v.width,v.height):F?i.renderbufferStorageMultisample(i.RENDERBUFFER,ot,q,v.width,v.height):i.renderbufferStorage(i.RENDERBUFFER,q,v.width,v.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,xt,i.RENDERBUFFER,b)}else{const $=v.textures;for(let Z=0;Z<$.length;Z++){const q=$[Z],xt=s.convert(q.format,q.colorSpace),ot=s.convert(q.type),ht=T(q.internalFormat,xt,ot,q.colorSpace),Yt=Gt(v);F&&Wt(v)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Yt,ht,v.width,v.height):Wt(v)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Yt,ht,v.width,v.height):i.renderbufferStorage(i.RENDERBUFFER,ht,v.width,v.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function At(b,v){if(v&&v.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(i.FRAMEBUFFER,b),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const $=n.get(v.depthTexture);$.__renderTarget=v,(!$.__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),J(v.depthTexture,0);const Z=$.__webglTexture,q=Gt(v);if(v.depthTexture.format===zi)Wt(v)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,Z,0,q):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,Z,0);else if(v.depthTexture.format===Xi)Wt(v)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,Z,0,q):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,Z,0);else throw new Error("Unknown depthTexture format")}function Lt(b){const v=n.get(b),F=b.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==b.depthTexture){const $=b.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),$){const Z=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,$.removeEventListener("dispose",Z)};$.addEventListener("dispose",Z),v.__depthDisposeCallback=Z}v.__boundDepthTexture=$}if(b.depthTexture&&!v.__autoAllocateDepthBuffer){if(F)throw new Error("target.depthTexture not supported in Cube render targets");At(v.__webglFramebuffer,b)}else if(F){v.__webglDepthbuffer=[];for(let $=0;$<6;$++)if(e.bindFramebuffer(i.FRAMEBUFFER,v.__webglFramebuffer[$]),v.__webglDepthbuffer[$]===void 0)v.__webglDepthbuffer[$]=i.createRenderbuffer(),st(v.__webglDepthbuffer[$],b,!1);else{const Z=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,q=v.__webglDepthbuffer[$];i.bindRenderbuffer(i.RENDERBUFFER,q),i.framebufferRenderbuffer(i.FRAMEBUFFER,Z,i.RENDERBUFFER,q)}}else if(e.bindFramebuffer(i.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=i.createRenderbuffer(),st(v.__webglDepthbuffer,b,!1);else{const $=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Z=v.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,Z),i.framebufferRenderbuffer(i.FRAMEBUFFER,$,i.RENDERBUFFER,Z)}e.bindFramebuffer(i.FRAMEBUFFER,null)}function Vt(b,v,F){const $=n.get(b);v!==void 0&&vt($.__webglFramebuffer,b,b.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),F!==void 0&&Lt(b)}function ce(b){const v=b.texture,F=n.get(b),$=n.get(v);b.addEventListener("dispose",A);const Z=b.textures,q=b.isWebGLCubeRenderTarget===!0,xt=Z.length>1;if(xt||($.__webglTexture===void 0&&($.__webglTexture=i.createTexture()),$.__version=v.version,o.memory.textures++),q){F.__webglFramebuffer=[];for(let ot=0;ot<6;ot++)if(v.mipmaps&&v.mipmaps.length>0){F.__webglFramebuffer[ot]=[];for(let ht=0;ht<v.mipmaps.length;ht++)F.__webglFramebuffer[ot][ht]=i.createFramebuffer()}else F.__webglFramebuffer[ot]=i.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){F.__webglFramebuffer=[];for(let ot=0;ot<v.mipmaps.length;ot++)F.__webglFramebuffer[ot]=i.createFramebuffer()}else F.__webglFramebuffer=i.createFramebuffer();if(xt)for(let ot=0,ht=Z.length;ot<ht;ot++){const Yt=n.get(Z[ot]);Yt.__webglTexture===void 0&&(Yt.__webglTexture=i.createTexture(),o.memory.textures++)}if(b.samples>0&&Wt(b)===!1){F.__webglMultisampledFramebuffer=i.createFramebuffer(),F.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let ot=0;ot<Z.length;ot++){const ht=Z[ot];F.__webglColorRenderbuffer[ot]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,F.__webglColorRenderbuffer[ot]);const Yt=s.convert(ht.format,ht.colorSpace),Q=s.convert(ht.type),dt=T(ht.internalFormat,Yt,Q,ht.colorSpace,b.isXRRenderTarget===!0),bt=Gt(b);i.renderbufferStorageMultisample(i.RENDERBUFFER,bt,dt,b.width,b.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ot,i.RENDERBUFFER,F.__webglColorRenderbuffer[ot])}i.bindRenderbuffer(i.RENDERBUFFER,null),b.depthBuffer&&(F.__webglDepthRenderbuffer=i.createRenderbuffer(),st(F.__webglDepthRenderbuffer,b,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(q){e.bindTexture(i.TEXTURE_CUBE_MAP,$.__webglTexture),Ht(i.TEXTURE_CUBE_MAP,v);for(let ot=0;ot<6;ot++)if(v.mipmaps&&v.mipmaps.length>0)for(let ht=0;ht<v.mipmaps.length;ht++)vt(F.__webglFramebuffer[ot][ht],b,v,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ot,ht);else vt(F.__webglFramebuffer[ot],b,v,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ot,0);m(v)&&u(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(xt){for(let ot=0,ht=Z.length;ot<ht;ot++){const Yt=Z[ot],Q=n.get(Yt);e.bindTexture(i.TEXTURE_2D,Q.__webglTexture),Ht(i.TEXTURE_2D,Yt),vt(F.__webglFramebuffer,b,Yt,i.COLOR_ATTACHMENT0+ot,i.TEXTURE_2D,0),m(Yt)&&u(i.TEXTURE_2D)}e.unbindTexture()}else{let ot=i.TEXTURE_2D;if((b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(ot=b.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(ot,$.__webglTexture),Ht(ot,v),v.mipmaps&&v.mipmaps.length>0)for(let ht=0;ht<v.mipmaps.length;ht++)vt(F.__webglFramebuffer[ht],b,v,i.COLOR_ATTACHMENT0,ot,ht);else vt(F.__webglFramebuffer,b,v,i.COLOR_ATTACHMENT0,ot,0);m(v)&&u(ot),e.unbindTexture()}b.depthBuffer&&Lt(b)}function qt(b){const v=b.textures;for(let F=0,$=v.length;F<$;F++){const Z=v[F];if(m(Z)){const q=E(b),xt=n.get(Z).__webglTexture;e.bindTexture(q,xt),u(q),e.unbindTexture()}}}const de=[],U=[];function Ge(b){if(b.samples>0){if(Wt(b)===!1){const v=b.textures,F=b.width,$=b.height;let Z=i.COLOR_BUFFER_BIT;const q=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,xt=n.get(b),ot=v.length>1;if(ot)for(let ht=0;ht<v.length;ht++)e.bindFramebuffer(i.FRAMEBUFFER,xt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ht,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,xt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ht,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,xt.__webglMultisampledFramebuffer),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,xt.__webglFramebuffer);for(let ht=0;ht<v.length;ht++){if(b.resolveDepthBuffer&&(b.depthBuffer&&(Z|=i.DEPTH_BUFFER_BIT),b.stencilBuffer&&b.resolveStencilBuffer&&(Z|=i.STENCIL_BUFFER_BIT)),ot){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,xt.__webglColorRenderbuffer[ht]);const Yt=n.get(v[ht]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Yt,0)}i.blitFramebuffer(0,0,F,$,0,0,F,$,Z,i.NEAREST),c===!0&&(de.length=0,U.length=0,de.push(i.COLOR_ATTACHMENT0+ht),b.depthBuffer&&b.resolveDepthBuffer===!1&&(de.push(q),U.push(q),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,U)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,de))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),ot)for(let ht=0;ht<v.length;ht++){e.bindFramebuffer(i.FRAMEBUFFER,xt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ht,i.RENDERBUFFER,xt.__webglColorRenderbuffer[ht]);const Yt=n.get(v[ht]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,xt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ht,i.TEXTURE_2D,Yt,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,xt.__webglMultisampledFramebuffer)}else if(b.depthBuffer&&b.resolveDepthBuffer===!1&&c){const v=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[v])}}}function Gt(b){return Math.min(r.maxSamples,b.samples)}function Wt(b){const v=n.get(b);return b.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function Tt(b){const v=o.render.frame;h.get(b)!==v&&(h.set(b,v),b.update())}function re(b,v){const F=b.colorSpace,$=b.format,Z=b.type;return b.isCompressedTexture===!0||b.isVideoTexture===!0||F!==$i&&F!==Xn&&($t.getTransfer(F)===te?($!==nn||Z!==In)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",F)),v}function yt(b){return typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement?(l.width=b.naturalWidth||b.width,l.height=b.naturalHeight||b.height):typeof VideoFrame<"u"&&b instanceof VideoFrame?(l.width=b.displayWidth,l.height=b.displayHeight):(l.width=b.width,l.height=b.height),l}this.allocateTextureUnit=z,this.resetTextureUnits=k,this.setTexture2D=J,this.setTexture2DArray=W,this.setTexture3D=j,this.setTextureCube=G,this.rebindTextures=Vt,this.setupRenderTarget=ce,this.updateRenderTargetMipmap=qt,this.updateMultisampleRenderTarget=Ge,this.setupDepthRenderbuffer=Lt,this.setupFrameBufferTexture=vt,this.useMultisampledRTT=Wt}function Bm(i,t){function e(n,r=Xn){let s;const o=$t.getTransfer(r);if(n===In)return i.UNSIGNED_BYTE;if(n===ra)return i.UNSIGNED_SHORT_4_4_4_4;if(n===sa)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Jc)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===$c)return i.BYTE;if(n===Kc)return i.SHORT;if(n===mr)return i.UNSIGNED_SHORT;if(n===ia)return i.INT;if(n===_i)return i.UNSIGNED_INT;if(n===wn)return i.FLOAT;if(n===vr)return i.HALF_FLOAT;if(n===Zc)return i.ALPHA;if(n===jc)return i.RGB;if(n===nn)return i.RGBA;if(n===Qc)return i.LUMINANCE;if(n===tl)return i.LUMINANCE_ALPHA;if(n===zi)return i.DEPTH_COMPONENT;if(n===Xi)return i.DEPTH_STENCIL;if(n===el)return i.RED;if(n===oa)return i.RED_INTEGER;if(n===nl)return i.RG;if(n===aa)return i.RG_INTEGER;if(n===ca)return i.RGBA_INTEGER;if(n===ts||n===es||n===ns||n===is)if(o===te)if(s=t.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===ts)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===es)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===ns)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===is)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=t.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===ts)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===es)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===ns)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===is)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===yo||n===Eo||n===To||n===bo)if(s=t.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===yo)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Eo)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===To)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===bo)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Ao||n===wo||n===Ro)if(s=t.get("WEBGL_compressed_texture_etc"),s!==null){if(n===Ao||n===wo)return o===te?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Ro)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Co||n===Po||n===Lo||n===Do||n===Io||n===Uo||n===No||n===Fo||n===Oo||n===Bo||n===zo||n===ko||n===Ho||n===Vo)if(s=t.get("WEBGL_compressed_texture_astc"),s!==null){if(n===Co)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Po)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Lo)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Do)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Io)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Uo)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===No)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Fo)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Oo)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Bo)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===zo)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===ko)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Ho)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Vo)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===rs||n===Go||n===Wo)if(s=t.get("EXT_texture_compression_bptc"),s!==null){if(n===rs)return o===te?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Go)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Wo)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===il||n===Xo||n===qo||n===Yo)if(s=t.get("EXT_texture_compression_rgtc"),s!==null){if(n===rs)return s.COMPRESSED_RED_RGTC1_EXT;if(n===Xo)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===qo)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Yo)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Wi?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}class zm extends Ye{constructor(t=[]){super(),this.isArrayCamera=!0,this.cameras=t}}class zt extends xe{constructor(){super(),this.isGroup=!0,this.type="Group"}}const km={type:"move"};class Js{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new zt,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new zt,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new P,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new P),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new zt,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new P,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new P),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const e=this._hand;if(e)for(const n of t.hand.values())this._getHandJoint(e,n)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,n){let r=null,s=null,o=null;const a=this._targetRay,c=this._grip,l=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(l&&t.hand){o=!0;for(const _ of t.hand.values()){const m=e.getJointPose(_,n),u=this._getHandJoint(l,_);m!==null&&(u.matrix.fromArray(m.transform.matrix),u.matrix.decompose(u.position,u.rotation,u.scale),u.matrixWorldNeedsUpdate=!0,u.jointRadius=m.radius),u.visible=m!==null}const h=l.joints["index-finger-tip"],p=l.joints["thumb-tip"],f=h.position.distanceTo(p.position),d=.02,g=.005;l.inputState.pinching&&f>d+g?(l.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!l.inputState.pinching&&f<=d-g&&(l.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else c!==null&&t.gripSpace&&(s=e.getPose(t.gripSpace,n),s!==null&&(c.matrix.fromArray(s.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,s.linearVelocity?(c.hasLinearVelocity=!0,c.linearVelocity.copy(s.linearVelocity)):c.hasLinearVelocity=!1,s.angularVelocity?(c.hasAngularVelocity=!0,c.angularVelocity.copy(s.angularVelocity)):c.hasAngularVelocity=!1));a!==null&&(r=e.getPose(t.targetRaySpace,n),r===null&&s!==null&&(r=s),r!==null&&(a.matrix.fromArray(r.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,r.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(r.linearVelocity)):a.hasLinearVelocity=!1,r.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(r.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(km)))}return a!==null&&(a.visible=r!==null),c!==null&&(c.visible=s!==null),l!==null&&(l.visible=o!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){const n=new zt;n.matrixAutoUpdate=!1,n.visible=!1,t.joints[e.jointName]=n,t.add(n)}return t.joints[e.jointName]}}const Hm=`
void main() {
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `}));i.add(t);const e=new Bt(new Fe(7.5,12,12),new qi({color:16773568}));e.position.set(-90,58,40),i.add(e);const n=new Bt(new Fe(16,12,12),new qi({color:16770720,transparent:!0,opacity:.22,depthWrite:!1}));n.position.copy(e.position),i.add(n);for(let r=0;r<9;r++){const s=new zt,o=new rn({color:15660280,flatShading:!0,transparent:!0,opacity:.78});for(let c=0;c<4;c++){const l=new Bt(new Fe(4.2+c%3,6,5),o);l.position.set((c-1.4)*5.2,c%2*1.4,c%3-1),s.add(l)}const a=r/9*Math.PI*2;s.position.set(Math.cos(a)*90,28+r%3*4,Math.sin(a)*90),s.userData.spin=.012+r%4*.004,s.userData.base=a,i.add(s)}return i}function T0(i,t){if(i)for(const e of i.children){if(!e.userData.spin)continue;const n=e.userData.base+t*e.userData.spin;e.position.x=Math.cos(n)*90,e.position.z=Math.sin(n)*90}}function b0(){const i=new ti(520,520,72,72);i.rotateX(-Math.PI/2);const t=new pn({transparent:!0,uniforms:{uTime:{value:0},uDeep:{value:new Et(2781076)},uShal:{value:new Et(7254985)},uFoam:{value:new Et(14479082)}},vertexShader:`
      uniform float uTime;
      varying vec3 vW;
      void main() {
        vec3 p = position;
  ...
  `}Ln.addEventListener("click",i=>{const t=i.target.closest("button");if(!t)return;const e=t.dataset.act;if(e==="close"){Cn();return}if(e==="connect"){Jt.connectPreviewWallet(),Re.ui(),ye("Preview wallet linked. No real keys."),hi();return}if(e==="burn"){const n=Jt.burnForRod(t.dataset.id);n.ok?(Re.burn(),ye(`Burned ${n.rod.burn} TOKEN · ${n.rod.name} unlocked`),Qo()):ye(n.reason),qn(),hi();return}if(e==="equip"){Jt.equip(t.dataset.id),Qo(),qn(),hi();return}if(e==="redeem"){const n=Jt.redeem(t.dataset.id);n.ok?ye(`Redeemed ${n.item.name} · ${vs(n.item.kind)}`):ye(n.reason),qn(),ta(Oe==="redeem");return}if(e==="tab"){zl=t.dataset.id,hi();return}if(e==="swap"){const n=Jt.buySwap(t.dataset.id);n.ok?(Re.ui(),ye(`Swapped credits for ${n.offer.name}`)):ye(n.reason),qn(),hi();return}if(e==="merch"){const n=Jt.buyMerch(t.dataset.id);n.ok?(Re.ui(),ye(`Claimed ${n.offer.name} (preview locker)`)):ye(n.reason),qn(),hi()}});function Vl(){if(Oe){Cn();return}An&&(An.id==="shop"&&Dn("shop"),An.id==="board"&&Dn("board"),An.id==="redeem"&&Dn("redeem"),An.id==="boat"&&(Ot.position.set(-28,1.4,4.2),ye("Skiff ride · offshore water is live. Cast from here with Elite.")))}function Wn(i,t,e){Oi&&(Oi.classList.remove("hidden","bite","reel"),i==="bite"&&Oi.classList.add("bite"),i==="reel"&&Oi.classList.add("reel"),Bc&&(Bc.textContent=i.toUpperCase()),ag.textContent=t,og.style.width=`${Math.max(0,Math.min(100,e))}%`)}function Gl(){const i=new P(0,0,-1).applyEuler(Ot.rotation);for(const t of[3.2,5.4,8.2,11]){const e=Ot.position.x+i.x*t,n=Ot.position.z+i.z*t;if(Ot.position.y+i.y*t<1.4&&dn(e,n)<.35)return{ok:!0,x:e,z:n}}return{ok:!1}}function hg(i){if(!Qn)return;document.getElementById("catch-rarity").textContent=i.rarity.toUpperCase(),document.getElementById("catch-name").textContent=i.name;const t=document.getElementById("catch-blurb");t&&(t.textContent=i.blurb||""),document.getElementById("catch-kind").textContent=vs(i.kind);const e=document.getElementById("catch-trade");e&&(e.textContent=Nl(i)),Qn.classList.remove("hidden"),pr=8,Kn.visible=!0,Re.catch(i.rarity==="Legendary"||i.rarity==="Mythic"||i.rarity==="Epic")}function dg(){if(Pt||Oe||!yr||Qn&&!Qn.classList.contains("hidden"))return;const i=Gl();if(!i.ok){ye("Look at the water to cast.");return}const t=Zo(i.x,i.z),e=Zo(Ot.position.x,Ot.position.z),n=t.fish?t:e;if(!(dn(i.x,i.z)<.35)){ye("Look at the water to cast.");return}const s=Jt.canFish(n.id);if(!s.ok){ye(s.reason);return}Pt={t:0,phase:"cast",zone:n.id,window:.85+Math.random()*.45,biteAt:1.25+Math.random()*1.7,bx:i.x,bz:i.z},Re.cast(),Wn("cast","THROWING LINE",12)}function fg(i){if(!Pt){gi.visible=!1;return}const t=Math.sin(i*3.2)*.05;gi.position.set(Pt.bx,.14+t,Pt.bz),gi.visible=Pt.phase!=="cast"||Pt.t>.28}function pg(i){if(!Pt){ur(sn,"idle",0),gi.visible=!1;return}if(Pt.t+=i,ur(sn,Pt.phase,Pt.t),fg(performance.now()/1e3),Pt.phase==="cast")Wn("cast","THROWING LINE",Pt.t/.42*100),Pt.t>=.42&&(Pt.phase="wait",Pt.t=0,Jo(_r,Pt.bx,.12,Pt.bz),Re.splash(),Wn("wait","WAITING FOR A BITE",0));else if(Pt.phase==="wait")Wn("wait","WAITING FOR A BITE",Pt.t/Pt.biteAt*100),Pt.t>=Pt.biteAt&&(Pt.phase="bite",Pt.t=0,Jo(_r,Pt.bx,.12,Pt.bz),Re.bite(),Wn("bite","BITE · CLICK / F",100),ye("Bite! Reel now."));else if(Pt.phase==="bite")Wn("bite","BITE · CLICK / F",(1-Pt.t/Pt.window)*100),Pt.t>Pt.window&&(Pt=null,gi.visible=!1,Oi.classList.add("hidden"),ur(sn,"idle",0),Re.miss(),ye("It got away."));else if(Pt.phase==="reel"&&(Wn("reel","REELING",Pt.t/.55*100),Pt.t>=.55)){const t=Pt.zone;Pt=null,gi.visible=!1,Oi.classList.add("hidden"),ur(sn,"idle",0);const e=Jt.rollCatch(t);e.ok?(qn(),hg(e.item),ye(`${e.item.rarity} · ${e.item.name}`)):ye(e.reason)}}function _a(){if(yr){if(!Pt){dg();return}Pt.phase==="bite"&&(Pt.phase="reel",Pt.t=0,Re.reel(),Wn("reel","REELING",0))}}function Hc(){return gr?1.05:1.62}function mg(){const i=Ot.position;An=null;let t=99;for(const n of $0){const r=Math.hypot(i.x-n.x,i.z-n.z);r<n.r&&r<t&&(t=r,An=n)}const e=Zo(i.x,i.z);if(ng.textContent=e.label,Oe){Zr.textContent="";return}An?Zr.textContent=An.label:Gl().ok&&Jt.state.equipped!=="none"?Zr.textContent="Cast":Zr.textContent=""}function Wl(i,t){$n.x-=i*.00225,$n.y-=t*.00225,$n.y=Math.max(-1.2,Math.min(1.2,$n.y))}function gg(i){const t=dn(Ot.position.x,Ot.position.z),e=t<.22,n=!!(we.ShiftLeft||we.ShiftRight),r=(n?8.4:5.1)*(gr?.42:1)*(e?.48:1)*(Pt?.32:1);qe.set(0,0,0),(we.KeyW||we.ArrowUp)&&(qe.z-=1),(we.KeyS||we.ArrowDown)&&(qe.z+=1),(we.KeyA||we.ArrowLeft)&&(qe.x-=1),(we.KeyD||we.ArrowRight)&&(qe.x+=1),hs&&(qe.x+=He.x,qe.z+=He.y),qe.lengthSq()>1&&qe.normalize(),qe.applyAxisAngle(cg.set(0,1,0),$n.x);const s=e?9:11;Se.x+=(qe.x*r-Se.x)*Math.min(1,i*s),Se.z+=(qe.z*r-Se.z)*Math.min(1,i*s),we._jump&&(Ot.position.y<=t+Hc()+.1&&(Se.y=e?4.2:6.4,Re.jump()),we._jump=!1),Se.y-=(e?12:20)*i;let o=Ot.position.x+Se.x*i,a=Ot.position.z+Se.z*i;const c=P0(o,a);(c.x!==o||c.z!==a)&&(Se.x*=.2,Se.z*=.2),Ot.position.x=c.x,Ot.position.z=c.z,Ot.position.y+=Se.y*i;const l=dn(Ot.position.x,Ot.position.z)+Hc(),h=Ot.position.y<=l+.08,p=l-Ot.position.y;p>0&&p<1.35&&Se.y<=1.2?(Ot.position.y+=Math.min(p,i*5.4),Se.y=Math.max(Se.y,0)):Ot.position.y<l&&(Ot.position.y=l,Se.y=0),h&&!kc&&e&&(Jo(_r,Ot.position.x,.1,Ot.position.z),Re.splash()),kc=h,Ot.rotation.y=$n.x,Ot.rotation.x=$n.y;const f=Math.hypot(Se.x,Se.z)>.4&&h;f&&(oo+=i*(n?12:8.2),ao+=i,ao>(n?.32:.44)&&(ao=0,e?Re.splash():Re.step()));const d=f?Math.sin(oo)*.032:0,g=f?Math.cos(oo*.5)*.014:0;sn&&(sn.position.set(g,d-(gr?.08:0),0),Pt||ur(sn,"idle",0)),Qr+=((n&&f?80:72)-Qr)*Math.min(1,i*6),Math.abs(Ot.fov-Qr)>.05&&(Ot.fov=Qr,Ot.updateProjectionMatrix()),zc&&(zc.style.transform=`rotate(${-$n.x}rad)`)}addEventListener("resize",()=>{Ot.aspect=innerWidth/innerHeight,Ot.updateProjectionMatrix(),Nn.setSize(innerWidth,innerHeight)});addEventListener("keydown",i=>{we[i.code]=!0,i.code==="KeyC"&&(gr=!0),i.code==="Space"&&(i.preventDefault(),we._jump=!0),i.code==="KeyE"&&Vl(),i.code==="KeyF"&&_a(),i.code==="KeyI"&&(Oe==="inv"?Cn():Dn("inv")),i.code==="KeyB"&&(Oe==="shop"?Cn():Dn("shop")),i.code==="Tab"&&(i.preventDefault(),Oe==="board"?Cn():Dn("board")),i.code==="Escape"&&(Cn(),document.exitPointerLock?.())});addEventListener("keyup",i=>{we[i.code]=!1,i.code==="KeyC"&&(gr=!1)});document.addEventListener("mousemove",i=>{!ga||Oe||Wl(i.movementX,i.movementY)});xi.addEventListener("click",()=>{!yr||Oe||Qn&&!Qn.classList.contains("hidden")||(!ga&&!hs?xi.requestPointerLock():_a())});document.addEventListener("pointerlockchange",()=>{ga=document.pointerLockElement===xi});function _g(){const i=document.getElementById("stick"),t=i.querySelector("i"),e=(o,a)=>{const c=i.getBoundingClientRect(),l=o-(c.left+c.width/2),h=a-(c.top+c.height/2),p=40,f=Math.hypot(l,h)||1,d=Math.min(1,f/p);He.x=l/f*d,He.y=h/f*d,t.style.transform=`translate(${He.x*p}px, ${He.y*p}px)`};i.addEventListener("pointerdown",o=>{He.active=!0,He.id=o.pointerId,i.setPointerCapture(o.pointerId),e(o.clientX,o.clientY)}),i.addEventListener("pointermove",o=>{!He.active||o.pointerId!==He.id||e(o.clientX,o.clientY)});const n=()=>{He.active=!1,He.x=0,He.y=0,t.style.transform=""};i.addEventListener("pointerup",n),i.addEventListener("pointercancel",n),Bl.addEventListener("click",o=>{const a=o.target.closest("button");a&&(a.dataset.act==="jump"&&(we._jump=!0),a.dataset.act==="use"&&Vl(),a.dataset.act==="cast"&&_a())});let r=0,s=0;xi.addEventListener("touchstart",o=>{const a=o.changedTouches[0];a.clientX<innerWidth*.42||(r=a.clientX,s=a.clientY)},{passive:!0}),xi.addEventListener("touchmove",o=>{const a=o.changedTouches[0];a.clientX<innerWidth*.42||(Wl(a.clientX-r,a.clientY-s),r=a.clientX,s=a.clientY)},{passive:!0})}document.getElementById("catch-keep")?.addEventListener("click",()=>{Qn.classList.add("hidden"),Kn.visible=!1,pr=0,Re.ui()});document.getElementById("enter-btn").addEventListener("click",()=>{Ol.classList.add("hidden"),tg.classList.remove("hidden"),yr=!0,j0(),Q0(),Re.ui(),hs&&Bl.classList.remove("hidden"),qn(),hs||xi.requestPointerLock()});document.querySelector(".hotbar")?.addEventListener("click",i=>{const t=i.target.closest("button");if(!t)return;const e=t.dataset.hot;e==="shop"&&(Oe==="shop"?Cn():Dn("shop")),e==="inv"&&(Oe==="inv"?Cn():Dn("inv")),e==="board"&&(Oe==="board"?Cn():Dn("board"))});function Vc(){eg.classList.add("hidden"),Ol.classList.remove("hidden")}if(matchMedia("(prefers-reduced-motion: reduce)").matches)Vc();else{const i=["Waking the lighthouse…","Stretching lanky fishermen…","Tuning the catch tables…","Preview wallet standing by…","Island is ready."];let t=0;const e=setInterval(()=>{t+=1;const n=Math.min(100,t*22);Fc&&(Fc.style.width=`${n}%`),Oc&&(Oc.textContent=i[Math.min(i.length-1,t-1)]),n>=100&&(clearInterval(e),setTimeout(Vc,280))},220)}_g();qn();let Gc=performance.now();function Xl(i){const t=Math.min(.05,(i-Gc)/1e3);Gc=i,yr&&(gg(t),pg(t),mg());for(const e of ar.people)S0(e,i/1e3,!1,e.userData.archetype==="FISHERMAN");if(ar.birds)for(const e of ar.birds){e.userData.orbit+=t*.22,e.position.set(Math.cos(e.userData.orbit)*e.userData.rad,e.userData.h+Math.sin(i/700+e.userData.orbit)*.4,Math.sin(e.userData.orbit)*e.userData.rad),e.lookAt(0,e.position.y,0);const n=Math.sin(i/140+e.userData.orbit)*.45;e.userData.wings&&(e.userData.wings[0].rotation.z=n,e.userData.wings[1].rotation.z=-n)}T0(kl,i/1e3),R0(_r,t),ar.ocean?.material?.uniforms?.uTime&&(ar.ocean.material.uniforms.uTime.value=i/1e3),Kn.visible&&(Kn.rotation.y+=t*1.6,Kn.position.y=-.12+Math.sin(i/220)*.02),os>0&&(os-=t,os<=0&&jo.classList.add("hidden")),pr>0&&(pr-=t,pr<=0&&(Qn?.classList.add("hidden"),Kn.visible=!1)),Nn.render(an,Ot),requestAnimationFrame(Xl)}requestAnimationFrame(Xl);
