...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:On,depthTest:!1,depthWrite:!1})}function Lo(){return new zn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ua(),fragmentShader:`
		...
		`,blending:On,depthTest:!1,depthWrite:!1})}function Do(){return new zn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ua(),fragmentShader:`
...
void main() {
  ...
  `}function ya(i=!1){const t=re.state.inventory;Tn.innerHTML=`
    <button class="close-x" type="button" data-act="close">✕</button>
  ...
  `}function eg(){const i={};for(const t of re.state.inventory)i[t.rarity]=(i[t.rarity]||0)+1;Tn.innerHTML=`
    <button class="close-x" type="button" data-act="close">✕</button>
